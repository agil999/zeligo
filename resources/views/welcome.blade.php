...
@else
                  ...
                  @else
                    <li class=" mx-2 nav-item bg-primary rounded">
                <a href="{{ route('login') }}" class="nav-link active" aria-current="page" href="#">Login</a>
              </li>

                        @if (Route::has('register'))
                        <li class="nav-item">
                <a class="nav-link active" href="{{ route('register') }}" aria-current="page" href="#">Register</a>
              </li>
...
<div class="container mt-1">
  ...
  <a href="{{ route('ujicoba') }}" class="text-decoration-none col-lg-3 col-md-2 col-sm-3 col-6 rounded mt-2">
    <div class="">
      <div class="card text-center bg-dark text-white">
  ...
  <a href="{{ route('login') }}" class="text-decoration-none col-lg-3 col-md-2 col-sm-3 col-6 rounded mt-2">
    <div class="">
      <div class="card text-center bg-dark text-white">
        <img src="https://tse2.mm.bing.net/th?id=OIP.qnbdLYDGS_uup1A0y0xLtAAAAA&pid=Api&P=0" class="card-img-top" alt="...">
        <div class="card-body">
